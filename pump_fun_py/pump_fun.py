...
from utils import get_coin_data, get_token_balance, send_transaction_jito, confirm_txn
...
def buy_jito(mint_str, sol_in=0.1, slippage_percent=.5, jito_fee=1_000_000):
    try:
        ...
        # Create transaction
        print("Creating transaction...")
        versioned_txn = VersionedTransaction(compiled_message, [payer_keypair])

        print("Sending transaction...")
        txn_sig = send_transaction_jito(versioned_txn)
